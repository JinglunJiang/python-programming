...
def summarize_weather(filename="weather.json"):
    ...
    temperature_high = list(temperature for temperature in data_formatted["daily"]["temperature_2m_max"] if temperature)
    temperature_low = list(temperature for temperature in data_formatted["daily"]["temperature_2m_min"] if temperature)
